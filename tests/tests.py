...
class ModuleParsingTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        with open('tests.config.json', encoding='utf-8') as jsf:
            self.control_module = json.load(jsf, object_hook=lambda d: namedtuple('X', d.keys())(*d.values())) #we use namedtuple for convenience in coding style
...
#     def setUp(self):
#         ModuleParsingTestCase.setUp(self)
#         pass
